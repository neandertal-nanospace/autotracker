...
/**
 * Taken from http://krishnalalstha.wordpress.com/2013/02/19/android-expandable-layout/
...
public class ExpandablePanel extends LinearLayout
{
    ...
    public ExpandablePanel(Context context, AttributeSet attrs)
    {
        ...
        if (contentId == 0)
        {
            throw new IllegalArgumentException("The content attribute is required and must "
