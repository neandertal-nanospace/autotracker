...
/**
 * Add/Edit repair event activity. Used to add or edit a repair event to DB.
 * 
 * @author neandertal
 * 
 */
public class RepairEventActivity extends AbstractEventActivity
{

    @Override
    protected int getAddTitleID()
    {
        return R.string.text_add_repair;
    }

    @Override
    protected int getEditTitleID()
    {
        return R.string.text_edit_repair;
    }

    @Override
    protected int getLayoutId()
    {
        return R.layout.activity_repair_event;
    }
    ...
    protected EventBean createNewEvent()
    {
        ...
        newEvent.setEventType(EventType.REPAIR_EVENT);
    ...
    {
        Log.d(RepairEventActivity.class.getName(), "loadEventToForm()");
    ...
    {
        Log.d(RepairEventActivity.class.getName(), "saveFormToEvent()");
